            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip content={metricDescriptions.cac}>
            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip content={metricDescriptions.conversionRate}>
                    <Info className="h-4 w-4 text-muted-foreground" />
                  </Tooltip>
                </div>
            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip content={metricDescriptions.automationLevel}>
                    <Info className="h-4 w-4 text-muted-foreground" />
                  </Tooltip>
                </div>
            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip content={metricDescriptions.roi}>
                    <Info className="h-4 w-4 text-muted-foreground" />
                  </Tooltip>
                </div>
