...
const services = [
  ...
  {
    icon: <Building className="h-8 w-8 mb-4 text-gold" />,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card key={index} className="bg-space-light p-8 hover:transform hover:scale-105 transition-transform duration-300">
