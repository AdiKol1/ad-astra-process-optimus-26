    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mt-8">
          <Card className="border-0 shadow-lg overflow-hidden">
            <div className="p-6 md:p-8 bg-gradient-to-r from-blue-600 to-indigo-700 text-white text-center">
              <h3 className="text-2xl font-bold mb-4">Ready to see your complete report?</h3>
              <p className="text-blue-100 mb-6">Get a comprehensive view of your assessment results with detailed insights and recommendations.</p>
              <Button 
                size="lg"
                className="bg-white text-blue-600 hover:bg-gray-100"
                onClick={() => {
                  telemetry.track('view_full_report_click', {
                    source: 'detailed_results',
                    timestamp: new Date().toISOString()
                  });
